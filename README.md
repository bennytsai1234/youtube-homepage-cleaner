...
### 最新版本: v1.5.6 (2025-12-25)

本專案目前採用 **GitHub Raw 直連更新機制**，確保使用者能以最快速度獲取最新的功能與修復。

#### 最近變更：
*   **v1.5.6**:
    *   🔧 **完整還原 v1.4.0**: 根據 v1.4.0 基準版本進行全面對照，補回所有遺漏功能：
        *   Anti-Adblock CSS 規則完善 (aria-hidden 修復, scroll-offset 重設等)
        *   會員專屬/合輯文字匹配備援規則
        *   互動增強完整邏輯 (內嵌預覽播放器, 頻道連結, findPrimaryLink)
    *   🎯 現在 v1.5.6 功能等於 v1.4.0 + 效能優化 + 新增規則
*   **v1.5.2**: 
