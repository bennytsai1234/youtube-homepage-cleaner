...
### 最新版本: v1.5.7 (2025-12-25)

本專案目前採用 **GitHub Raw 直連更新機制**，確保使用者能以最快速度獲取最新的功能與修復。

#### 最近變更：
*   **v1.5.7**:
    *   🆕 **支援新版 YouTube 佈局**: 完整支援 `yt-lockup-view-model` 結構的影片卡片，修復低觀看數影片無法被過濾的問題。
    *   📊 更新 metadata 解析器，新增 `.yt-content-metadata-view-model__metadata-text` 等選擇器。
    *   ⏱️ 更新時長解析器，支援 `badge-shape .yt-badge-shape__text` 結構。
*   **v1.5.6**:
    *   🔧 **完整還原 v1.4.0**: 補回所有遺漏功能 (Anti-Adblock CSS, 文字匹配規則, 互動增強)
*   **v1.5.2**: 
