...
### 最新版本: v1.5.5 (2025-12-25)

本專案目前採用 **GitHub Raw 直連更新機制**，確保使用者能以最快速度獲取最新的功能與修復。

#### 最近變更：
*   **v1.5.5**:
    *   🔧 **補回遺漏功能**: 從 v1.4.0 補回「首頁推薦播放清單過濾」及「會員優先 (Early Access) 過濾」功能。
    *   🖱️ **點擊衝突修復**: 完整恢復 v1.4.0 的互動排除清單，避免干擾訂閱按鈕、進度條等元素。
*   **v1.5.4**:
    *   🛠️ **互動修復**: 解決了部分情況下只有第一個影片會在新分頁開啟，後續點擊無效的問題。
*   **v1.5.2**: 
